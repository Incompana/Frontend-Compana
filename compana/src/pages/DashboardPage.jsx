...
const EMPTY_CARDS = [
  {
    ...
    desc: "Kamu belum memulai langkah pertamamu. Mulai sekarang dan bangun karirmu!",
    cta: "Mulai Langkah Pertama →",
    action: "task",
  },
  {
    icon: "💬",
    title: "Belum ada feedback",
    desc: "Submit task pertamamu untuk mendapatkan feedback dari Compana AI.",
    cta: "Lihat Task Aktif",
    action: "task",
  },
  {
    icon: "📊",
    title: "Perjalananmu dimulai di sini",
    desc: "Jawab beberapa pertanyaan singkat untuk mendapatkan action plan yang personal.",
...
const AI_THINKING_CARDS = [
  {
    ...
    steps: [
      ...
      { done: false, spinning: true, text: "Menentukan target role..." },
      { done: false, spinning: false, text: "Menyusun action plan" },
    ],
  },
  {
    icon: "🔍",
    title: "Mengevaluasi taskmu...",
    desc: "AI memeriksa kode dan menyiapkan feedback.",
    steps: [
      { done: true, text: "File diterima" },
      { done: true, text: "Membaca struktur kode" },
      { done: false, spinning: true, text: "Menyiapkan feedback..." },
    ],
  },
  {
    icon: "🗺️",
    ...
    steps: [
      ...
      { done: false, spinning: true, text: "Membuat urutan langkah..." },
    ],
  },
];
  ...
  return (
    <div
      style={{
        ...
        boxShadow: hov ? "0 10px 32px rgba(0,0,0,0.22)" : "0 2px 12px rgba(0,0,0,0.12)",
        cursor: "default",
      }}
      ...
      {card.steps.map((step, i) => (
        <div key={i} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span
            style={{
              fontSize: "12px",
              color: step.done ? "#3dba74" : step.spinning ? "#d4a844" : "rgba(255,255,255,0.25)",
              animation: step.spinning ? "spin 1.2s linear infinite" : "none",
              display: "inline-block",
            }}
          >
            {step.done ? "✓" : step.spinning ? "◌" : "◌"}
          </span>
          <span
            style={{
              fontFamily: "'DM Sans', sans-serif",
    ...
    >
      ...
      <div
        style={{
          ...
          border: `1.5px solid ${isLocked ? "rgba(255,255,255,0.12)" : "rgba(61,186,116,0.4)"}`,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          fontSize: isLocked ? "14px" : "13px",
          color: isDone ? "white" : isActive ? "white" : "rgba(255,255,255,0.4)",
          fontWeight: 700,
          flexShrink: 0,
        }}
      >
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "5px", flexShrink: 0 }}>
        <span
          style={{
            ...
            padding: "3px 10px",
            borderRadius: "999px",
            border: `1px solid ${isLocked ? "rgba(255,255,255,0.08)" : "rgba(61,186,116,0.2)"}`,
          }}
        >
          {step.badge}
        </span>
...
export default function DashboardPage({ onNavigate }) {
  ...
  const navigate = (page) => onNavigate && onNavigate(page);
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Right: locked tooltip + just unlocked */}
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              {/* Locked step — hover tooltip demo */}
              <div
                style={{
                  background: "rgba(255,255,255,0.04)",
                  border: "1px solid rgba(255,255,255,0.09)",
                ...
                >
                  <p
                    style={{
                      ...
                      gap: "6px",
                      textDecoration: "underline",
                      textDecorationColor: "rgba(224,90,90,0.3)",
                      textUnderlineOffset: "2px",
                    }}
                  >
                    🔒 Langkah ini masih terkunci
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <p
                      style={{
                        ...
                        margin: 0,
                        textDecoration: "underline",
                        textDecorationColor: "rgba(61,186,116,0.2)",
                        textUnderlineOffset: "2px",
                      }}
                    >
